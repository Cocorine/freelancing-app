                ...
                <div class="col-lg-2">
                    <div class="footer-widget footer-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="#">{{ __('Freelancer Detail') }}s</a></li>
                            <li><a href="{{ route('jobs.index') }}">{{ __('Project') }}</a></li>
                            <li><a href="#">{{ __('Project Details') }}</a></li>
                            <li><a href="{{ route('backend.projects.create') }}">{{ __('Post Project') }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3">
