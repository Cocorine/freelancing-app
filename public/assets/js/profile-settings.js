...
(function($) {
    ...
    $(".add-award").on('click', function () {
		...
		var awardcontent = '<div class="form-row align-items-center award-cont">' +
			'<div class="form-group col-md-2">' +
				...
				'<i class="fas fa-plus"></i> <input type="file"  accept="image/*" name="awardsProfile[]">' +
				'</label>' +
			'</div>' +
    ...
    $(".add-exp").on('click', function () {
		...
		var expcontent = '<div class="form-row align-items-center exp-cont">' +
			...
			'<div class="form-group col-md-6">' +
				...
				'<input type="text" class="form-control datetimepicker" name="experience_starts[]">' +
			'</div>' +
			'<div class="form-group col-md-6">' +
				'<label>End date</label>' +
				'<input type="text" class="form-control datetimepicker" name="experience_ends[]">' +
			'</div>' +
    ...
    $(".education-info").on('click','.trash-icon', function () {
		$(this).closest('.add-education').remove();
		return false;
    });

    $(".add-education").on('click', function () {

		var educationcontent = '<div class="form-row align-items-center add-education">' +
			'<div class="form-group col-md-12">' +
